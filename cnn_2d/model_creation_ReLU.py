...
class Model_CUI_CNN3:
    ...
    def build_model(self):
        ...
        self.model.add(Conv2D(160, (5, 5), padding='same', activation='relu', activity_regularizer=l2(0.01)))
        self.model.add(Conv2D(500, (4, 4), activation='relu', activity_regularizer=l2(0.01)))
        self.model.add(Conv2D(19, (2, 2), activation='relu', activity_regularizer=l2(0.01)))
